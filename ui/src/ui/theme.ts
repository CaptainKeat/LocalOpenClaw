export type ThemeName = "claw" | "knot" | "dash" | "goon";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["claw", "knot", "dash", "goon"]);
...
export function resolveTheme(theme: ThemeName, mode: ThemeMode): ResolvedTheme {
  ...
  if (theme === "goon") {
    return resolvedMode === "light" ? "goonclaw-light" : "goonclaw";
  }
